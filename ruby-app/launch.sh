...
# agnostic.
#
# If done correctly you can use this script to run the app on your laptop as
# well as it being the entry point when the app is deployed in production.
#
# This script is utltimately created and controlled by the developers.  So this
# is just an example of how we'd do it for our ruby apps.
# 
